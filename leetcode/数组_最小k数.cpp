...
int main() {
    ...
    for (int i = 0; i < res.size(); ++i) {
        if (vec1[i] != res[i]) {
            cout << i << "vec(" << vec1[i] << ") res(" << res[i] << ")" << endl;
            return 0;
        }
    }
